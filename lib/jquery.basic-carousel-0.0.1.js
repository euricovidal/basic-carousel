...
(function ($) {
  $.fn.basicCarousel = function(options) {
    ...
    *******************************/
    ...
    var itemsWidth   = child.children().first().width() + 0.5; // should be set width (on example li) to work fine
    var stepLength   = ( itemsWidth + settings.marginOfItem ) * settings.visibleItems;
    ...
    var methods = {
      ...
      *******************************/
      initializeItems : function() {
        object.css({position : 'relative', display: 'hidden'});
